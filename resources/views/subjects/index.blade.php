						...
						@foreach ($subjects as $classroom)
							<tr>
		                        ...
		                        <td>
		                        	...
		                        	<div>
		                        		<a href="{{ route('subjects.edit', $classroom->id) }}" class="btn btn-flat btn-link btn-xs">Edit</a>
    									{!! Form::open(['route' => ['subjects.destroy', $classroom->id], 'method' => 'delete', 'class' => 'form-delete-inline']) !!}
