...
@section('page_description')
    <a href="{{ route('majors.create') }}" class="btn btn-flat btn-info btn-xs"><i class="fa fa-plus"></i> Tambah Baru</a>
@endsection
						...
						@foreach ($majors as $major)
							<tr>
		                        ...
		                        <td>
		                        	<div>{{ $major->name }}</div>
		                        	<div>
		                        		<a href="{{ route('majors.edit', $major->id) }}" class="btn btn-flat btn-link btn-xs">Edit</a>
    									{!! Form::open(['route' => ['majors.destroy', $major->id], 'method' => 'delete', 'class' => 'form-delete-inline']) !!}
