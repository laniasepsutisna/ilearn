<div class="box-body">
    ...
    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
        {!! Form::label('title', 'Judul Pengumuman', ['class' => 'col-md-3 control-label']) !!}
        <div class="col-md-6">
    ...
    <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
        {!! Form::label('urgensi', 'Urgensi', ['class' => 'col-md-3 control-label']) !!}
        <div class="col-md-6">
    ...
    <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
        {!! Form::label('konten-pengumuman', 'Konten Pengumuman', ['class' => 'col-md-3 control-label']) !!}
        <div class="col-md-9">
