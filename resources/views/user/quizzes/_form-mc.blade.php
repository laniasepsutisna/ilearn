<div id="questions-container">
	<div class="questions-wrapper clearfix" id="question-1">
		<div class="col-sm-1 text-center">
			<strong class="count-question btn btn-primary">1</strong>
			<div style="margin: 10px 0"><button class="remove-question btn btn-danger btn-sm"><i class="fa fa-close"></i></button></div>
		</div>
		<div class="col-sm-11">
			{!! Form::hidden('quiz_id', $quiz->id) !!}
			<div class="form-group {{ $errors->has('question') ? 'has-error' : '' }}">
				{!! Form::label('question', 'Pertanyaan', ['class' => 'control-label']) !!}
				{!! Form::textarea('question', null, ['class' => 'form-control textarea', 'id' => 'question', 'placeholder' => 'Pertanyaan...', 'rows' => '5']) !!}
				{!! $errors->first('question', '<p class="help-block">:message</p>') !!}
			</div>

			<div class="row">
				<div class="form-group col-sm-6 {{ $errors->has('answer_1') ? 'has-error' : '' }}">
				...
				<div class="form-group col-sm-6 {{ $errors->has('answer_2') ? 'has-error' : '' }}">
				...
				<div class="form-group col-sm-6 {{ $errors->has('answer_3') ? 'has-error' : '' }}">
				...
				<div class="form-group col-sm-6 {{ $errors->has('answer_4') ? 'has-error' : '' }}">
